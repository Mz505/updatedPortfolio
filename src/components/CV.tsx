      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12 pt-20 sm:pt-32 pb-12">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col sm:flex-row sm:flex-wrap gap-2 sm:gap-4 text-xs sm:text-sm text-gray-300">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="break-all">linkedin.com/in/mashal-zerak-b62947257</span>
              </div>
              <div className="flex items-center gap-2">
                <Github className="w-4 h-4 flex-shrink-0" />
                <span className="break-all">github.com/mz505</span>
              </div>
            </div>
          </div>
          <Button 
        ...
        <section className="mb-8 sm:mb-12">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <Card className="bg-transparent backdrop-blur-sm border-gray-600/50 p-4 sm:p-6 shadow-lg">
              <h3 className="text-lg sm:text-xl font-semibold text-cyan-400 mb-2 sm:mb-3">E-Commerce Website (MERN Stack)</h3>
              <p className="text-white text-sm sm:text-base">
            ...
            <Card className="bg-transparent backdrop-blur-sm border-gray-600/50 p-4 sm:p-6 shadow-lg">
              <h3 className="text-lg sm:text-xl font-semibold text-cyan-400 mb-2 sm:mb-3">Explor-Afghanistan (Mobile App) - Coming Soon</h3>
              <p className="text-white text-sm sm:text-base">
                A soon-to-be-launched travel companion app designed to make exploring Afghanistan seamless and enjoyable. 
                Built with a focus on user convenience, the app enables tourists to book hotels, reserve transport, hire 
                professional guides, and access AI-powered recommendations tailored to their journey. Features include live 
                maps, real-time weather updates, traffic insights, and location-based information for safe and informed travel. 
                Currently under development and will be available soon on the Google Play Store.
              </p>
            </Card>
          </div>
        </section>
