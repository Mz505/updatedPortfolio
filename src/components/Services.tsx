...
import { Code, Bot, Smartphone, Database, Cloud, Palette } from 'lucide-react';
...
const Services = () => {
  ...
  return (
    <section id="services" className="py-20 w-full relative overflow-hidden bg-black">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => {
            ...
            return (
              <div 
                key={index}
                className="group bg-transparent backdrop-blur-sm p-8 rounded-2xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20 animate-slide-up"
