...
import { FileText, Calendar, User, Download, Eye, ExternalLink, BookOpen, Code, Briefcase } from 'lucide-react';
          ...
          >
            ...
            <div className="space-y-3 sm:space-y-4">
              <div>
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white mb-2 group-hover:text-purple-400 transition-colors duration-300">
                  {doc.title}
                </h3>
