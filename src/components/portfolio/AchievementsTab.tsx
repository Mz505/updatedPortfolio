...
const AchievementsTab = () => {
  ...
  return (
    <div className="relative">
      {/* Timeline Line */}
      <div className="absolute left-3 sm:left-4 md:left-1/2 transform md:-translate-x-px top-0 bottom-0 w-0.5 bg-gradient-to-b from-purple-500 via-pink-500 to-purple-500"></div>
          ...
          return (
            ...
            >
              ...
              <div className={`group ml-12 sm:ml-16 md:ml-0 md:w-5/12 ${isEven ? 'md:pr-16' : 'md:pl-16'}`}>
                <div className="bg-gray-800/50 backdrop-blur-sm p-4 sm:p-6 rounded-2xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 sm:hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20">
                  {/* Year Badge */}
